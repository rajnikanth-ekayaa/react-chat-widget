...
function Conversation({
	...
	return (
		<div id='rcw-conversation-container' onMouseDown={initResize} className={cn('rcw-conversation-container', className)} aria-live='polite'>
			{resizable && <div className='rcw-conversation-resizer' />}
			{title && subtitle && (
				<Header title={title} subtitle={subtitle} toggleChat={toggleChat} showCloseButton={showCloseButton} titleAvatar={titleAvatar} />
			)}
